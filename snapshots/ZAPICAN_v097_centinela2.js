...
function addPlaceholderLand(name, path, { scale, yOffset = 0, count, rMin, rMax, minDistFromPOI = 3, minDistFromOther = 3 }) {
...
function addPlaceholderWaterEdge(name, path, { scale, yOffset = 0, count, scaleMin, scaleMax, minDistFromOther = 2.5 }) {
  for (let i = 0; i < count; i++) {
    let x, z, tries = 0;
    do {
...
addPlaceholderLand("guazubira", "/assets/models/guazubira.glb", { scale: 0.532, count: 1, rMin: 6, rMax: 16, minDistFromOther: 4 });
...
addPlaceholderLand("cardenal", "/assets/models/cardenal.glb", { scale: 0.146, count: 2, rMin: 5, rMax: 14, minDistFromOther: 2.5 });
addPlaceholderWaterEdge("garza_mora", "/assets/models/garza_mora.glb", { scale: 0.498, count: 1, scaleMin: 1.0, scaleMax: 1.1 });
